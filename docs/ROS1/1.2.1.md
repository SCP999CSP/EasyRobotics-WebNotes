...
Friendly reminder: Due to network connectivity issues causing timeouts, the installation may fail as shown below:![09\_安装异常](/ROS1\1.2.1\09_安装异常.png)You can repeatedly execute the update and installation commands until successful.
...
![img](/ROS1\1.2.1\rosdep正常初始化.png)

![img](/ROS1\1.2.1\rosdep正常更新.png)
