...
1. After successful ROS installation, you can run the built-in demo: This demo controls turtle movement via the keyboard.![img](/ROS1/1/1.gif)
2. Using VScode as the integrated development environment can improve development efficiency.![img](/ROS1/1/vscode.gif)