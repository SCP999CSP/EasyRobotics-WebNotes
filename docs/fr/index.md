...
hero:
  name: "Compétences fondamentales pour l’apprentissage de la robotique"
  text: "Pour les débutants"
  tagline: >
    Ces cours présentent les technologies clés utilisées en robotique
    et offrent une expérience pratique avec Linux, Python, OpenCV et ROS.
...
features:
  ...
  - icon: 🤖
    title: ROS
    details: >
      Dans ce cours, les étudiants apprendront les concepts fondamentaux de ROS
      et comment créer des nœuds communiquant via des topics,
      afin de se préparer au développement et à l’organisation de systèmes robotiques réels.
