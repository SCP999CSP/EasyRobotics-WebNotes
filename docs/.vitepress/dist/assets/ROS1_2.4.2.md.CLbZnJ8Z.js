import{_ as n,c as p,o as a,af as i}from"./chunks/framework.DSuiHQgX.js";const h=JSON.parse('{"title":"2.4.2 rostopic","description":"","frontmatter":{},"headers":[],"relativePath":"ROS1/2.4.2.md","filePath":"ROS1/2.4.2.md"}'),l={name:"ROS1/2.4.2.md"};function t(e,s,o,r,c,g){return a(),p("div",null,[...s[0]||(s[0]=[i(`<h1 id="_2-4-2-rostopic" tabindex="-1">2.4.2 rostopic <a class="header-anchor" href="#_2-4-2-rostopic" aria-label="Permalink to “2.4.2 rostopic”">​</a></h1><p><strong>rostopic</strong>包含rostopic命令行工具，用于显示有关ROS 主题的调试信息，包括发布者，订阅者，发布频率和ROS消息。它还包含一个实验性Python库，用于动态获取有关主题的信息并与之交互。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>rostopic bw     显示主题使用的带宽</span></span>
