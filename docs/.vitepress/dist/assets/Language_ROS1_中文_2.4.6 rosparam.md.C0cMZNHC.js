import{_ as a,c as n,o as p,af as i}from"./chunks/framework.Cf416Sfo.js";const g=JSON.parse('{"title":"2.4.6 rosparam","description":"","frontmatter":{},"headers":[],"relativePath":"Language/ROS1/中文/2.4.6 rosparam.md","filePath":"Language/ROS1/中文/2.4.6 rosparam.md"}'),e={name:"Language/ROS1/中文/2.4.6 rosparam.md"};function l(t,s,r,o,h,c){return p(),n("div",null,[...s[0]||(s[0]=[i(`<h1 id="_2-4-6-rosparam" tabindex="-1">2.4.6 rosparam <a class="header-anchor" href="#_2-4-6-rosparam" aria-label="Permalink to “2.4.6 rosparam”">​</a></h1><p>rosparam包含rosparam命令行工具，用于使用YAML编码文件在参数服务器上获取和设置ROS参数。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>rosparam set    设置参数</span></span>
