import{_ as a,c as n,o as p,af as i}from"./chunks/framework.Cf416Sfo.js";const d=JSON.parse('{"title":"2.4.5 rossrv","description":"","frontmatter":{},"headers":[],"relativePath":"Language/ROS1/English/2.4.5 rossrv.md","filePath":"Language/ROS1/English/2.4.5 rossrv.md"}'),e={name:"Language/ROS1/English/2.4.5 rossrv.md"};function l(r,s,t,o,c,h){return p(),n("div",null,[...s[0]||(s[0]=[i(`<h1 id="_2-4-5-rossrv" tabindex="-1">2.4.5 rossrv <a class="header-anchor" href="#_2-4-5-rossrv" aria-label="Permalink to “2.4.5 rossrv”">​</a></h1><p>rossrv是用于显示有关ROS服务类型的信息的命令行工具，与 rosmsg 使用语法高度雷同。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>rossrv show    显示服务消息详情</span></span>
...
<span class="line"><span>string name</span></span></code></pre></div></li><li><p>rossrv info</p><p>作用与 rossrv show 一致</p></li><li><p>rossrv md5</p><p>对 service 数据使用 md5 校验(加密)</p></li></ul>`,4)])])}const v=a(e,[["render",l]]);export{d as __pageData,v as default};
