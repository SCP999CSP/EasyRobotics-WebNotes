import{_ as a,c as n,o as e,af as p}from"./chunks/framework.DSuiHQgX.js";const d=JSON.parse('{"title":"2.4.4 rosservice","description":"","frontmatter":{},"headers":[],"relativePath":"Language/ROS1/中文/2.4.4 rosservice.md","filePath":"Language/ROS1/中文/2.4.4 rosservice.md"}'),i={name:"Language/ROS1/中文/2.4.4 rosservice.md"};function l(r,s,t,c,o,g){return e(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="_2-4-4-rosservice" tabindex="-1">2.4.4 rosservice <a class="header-anchor" href="#_2-4-4-rosservice" aria-label="Permalink to “2.4.4 rosservice”">​</a></h1><p>rosservice包含用于列出和查询ROS<a href="http://wiki.ros.org/Services" target="_blank" rel="noreferrer">Services</a>的rosservice命令行工具。</p><p>调用部分服务时，如果对相关工作空间没有配置 path，需要进入工作空间调用 source ./devel/setup.bash</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>rosservice args 打印服务参数</span></span>
