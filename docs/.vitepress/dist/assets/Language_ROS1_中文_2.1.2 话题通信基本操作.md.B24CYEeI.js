import{_ as i,c as a,o as n,af as l}from"./chunks/framework.DSuiHQgX.js";const g=JSON.parse('{"title":"2.1.2 话题通信基本操作","description":"","frontmatter":{},"headers":[],"relativePath":"Language/ROS1/中文/2.1.2 话题通信基本操作.md","filePath":"Language/ROS1/中文/2.1.2 话题通信基本操作.md"}'),p={name:"Language/ROS1/中文/2.1.2 话题通信基本操作.md"};function h(k,s,t,e,r,E){return n(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="_2-1-2-话题通信基本操作" tabindex="-1">2.1.2 话题通信基本操作 <a class="header-anchor" href="#_2-1-2-话题通信基本操作" aria-label="Permalink to “2.1.2 话题通信基本操作”">​</a></h1><p><strong>需求:</strong></p><blockquote><p>编写发布订阅实现，要求发布方以10HZ(每秒10次)的频率发布文本消息，订阅方订阅消息并将消息内容打印输出。</p></blockquote><p><strong>分析:</strong></p><p>在模型实现中，ROS master 不需要实现，而连接的建立也已经被封装了，需要关注的关键点有三个:</p><ol><li>发布方</li><li>接收方</li><li>数据(此处为普通文本)</li></ol><p><strong>流程:</strong></p><ol><li>编写发布方实现；</li><li>编写订阅方实现；</li><li>为python文件添加可执行权限；</li><li>编辑配置文件；</li><li>编译并执行。</li></ol><h4 id="_1-发布方" tabindex="-1">1.发布方 <a class="header-anchor" href="#_1-发布方" aria-label="Permalink to “1.发布方”">​</a></h4><div class="language-py"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#! /usr/bin/env python</span></span>
