import{_ as a,c as n,o as i,af as p,bb as e}from"./chunks/framework.DSuiHQgX.js";const o=JSON.parse('{"title":"2.2.2 服务通信自定义srv","description":"","frontmatter":{},"headers":[],"relativePath":"Language/ROS1/中文/2.2.2 服务通信自定义srv.md","filePath":"Language/ROS1/中文/2.2.2 服务通信自定义srv.md"}'),l={name:"Language/ROS1/中文/2.2.2 服务通信自定义srv.md"};function t(r,s,h,d,c,g){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="_2-2-2-服务通信自定义srv" tabindex="-1">2.2.2 服务通信自定义srv <a class="header-anchor" href="#_2-2-2-服务通信自定义srv" aria-label="Permalink to “2.2.2 服务通信自定义srv”">​</a></h1><p><strong>需求:</strong></p><blockquote><p>服务通信中，客户端提交两个整数至服务端，服务端求和并响应结果到客户端，请创建服务器与客户端通信的数据载体。</p></blockquote><p><strong>流程:</strong></p><p>srv 文件内的可用数据类型与 msg 文件一致，且定义 srv 实现流程与自定义 msg 实现流程类似:</p><ol><li>按照固定格式创建srv文件</li><li>编辑配置文件</li><li>编译生成中间文件</li></ol><h4 id="_1-定义srv文件" tabindex="-1">1.定义srv文件 <a class="header-anchor" href="#_1-定义srv文件" aria-label="Permalink to “1.定义srv文件”">​</a></h4><p>服务通信中，数据分成两部分，请求与响应，在 srv 文件中请求和响应使用<code>---</code>分割，具体实现如下:</p><p>功能包下新建 srv 目录，添加 xxx.srv 文件，内容:</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span># 客户端请求时发送的两个数字</span></span>
