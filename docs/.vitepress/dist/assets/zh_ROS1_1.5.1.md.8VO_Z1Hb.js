import{_ as a,c as i,o as n,af as l,c5 as p}from"./chunks/framework.DSuiHQgX.js";const A=JSON.parse('{"title":"1.5.1 ROS文件系统","description":"","frontmatter":{},"headers":[],"relativePath":"zh/ROS1/1.5.1.md","filePath":"zh/ROS1/1.5.1.md"}'),e={name:"zh/ROS1/1.5.1.md"};function t(h,s,k,d,r,c){return n(),i("div",null,[...s[0]||(s[0]=[l('<h1 id="_1-5-1-ros文件系统" tabindex="-1">1.5.1 ROS文件系统 <a class="header-anchor" href="#_1-5-1-ros文件系统" aria-label="Permalink to “1.5.1 ROS文件系统”">​</a></h1><p>ROS文件系统级指的是在硬盘上ROS源代码的组织形式，其结构大致可以如下图所示：</p><p><img src="'+p+`" alt="img"></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>WorkSpace --- 自定义的工作空间</span></span>
