export default{
      ...
      text: 'Linux 笔记'},
      {
        ...
        items: [
          { text: '1.1 What Is Linux', 
            ...
            collapsed: true,
            items: [
              { text: '1.1.1 Linux Basics', link: '/Linux/1.1.1' },
              { text: '1.1.2 Basic Linux Operations and Commands', link: '/Linux/1.1.2' },
              { text: '1.1.3 Evolution of ROS', link: '/Linux/1.1.3' },
            ]
           },
    ...
    '/zh/ROS1/':[{
        text: 'ROS1 课件'},
      {
        ...
        items: [
          { text: '1.1 ROS简介', 
            ...
            collapsed: true,
            items: [
              { text: '1.1.1ROS概念', link: '/zh/ROS1/1.1.1' },
              { text: '1.1.2ROS设计目标', link: '/zh/ROS1/1.1.2' },
              { text: '1.1.3ROS发展历程', link: '/zh/ROS1/1.1.3' }
            ]
           },
           { text: '1.2 ROS安装', 
            link: '/zh/ROS1/1.2.0',
            collapsed: true,
            items: [
              { text: '1.2.1 安装 ROS', link: '/zh/ROS1/1.2.1' },
              { text: '1.2.2 测试 ROS', link: '/zh/ROS1/1.2.2' }
            ]
           },
           { text: '1.3 ROS快速体验', 
            link: '/zh/ROS1/1.3.0',
            collapsed: true,
            items: [
              { text: '1.3.1 HelloWorld实现简介', link: '/zh/ROS1/1.3.1' },
              { text: '1.3.2 HelloWorld', link: '/zh/ROS1/1.3.2' }
            ]
           },
          { text: '1.4 ROS集成开发环境搭建', 
            ...
            collapsed: true,
            items: [
              { text: '1.4.1 安装终端', link: '/zh/ROS1/1.4.1' },
              { text: '1.4.2 安装VScode', link: '/zh/ROS1/1.4.2' },
              { text: '1.4.3 launch文件演示', link: '/zh/ROS1/1.4.3' },
            ]
           },
           { text: '1.5 ROS架构', 
            link: '/zh/ROS1/1.5.0',
            collapsed: true,
            items: [
              { text: '1.5.1 ROS文件系统', link: '/zh/ROS1/1.5.1' },
              { text: '1.5.2 ROS文件系统相关命令', link: '/zh/ROS1/1.5.2' },
              { text: '1.5.3 ROS计算图', link: '/zh/ROS1/1.5.3' },
            ]
           },
           { text: '1.6 本章小结', link: '/zh/ROS1/1.6.0'},
        ]
      },
...

      {
        ...
        link: '/zh/ROS1/2.0.0',
        items: [
          { text: '2.1 话题通信', link: '/zh/ROS1/2.1.0',collapsed: true,
            items: [
               { text: '2.1.1 话题通信理论模型', link: '/zh/ROS1/2.1.1' },
               { text: '2.1.2 话题通信基本操作', link: '/zh/ROS1/2.1.2' },
               { text: '2.1.3 话题通信自定义msg', link: '/zh/ROS1/2.1.3' },
               { text: '2.1.4 话题通信自定义msg调用', link: '/zh/ROS1/2.1.4' }
            ]
          },
          { text: '2.2 服务通信', link: '/zh/ROS1/2.2.0',collapsed: true,
            items: [
                { text: '2.2.1 服务通信理论模型', link: '/zh/ROS1/2.2.1' },
                { text: '2.2.2 服务通信自定义srv', link: '/zh/ROS1/2.2.2' },
                { text: '2.2.3 服务通信自定义srv调用', link: '/zh/ROS1/2.2.3' },
            ]
           },
          { text: '2.3 参数服务器', link: '/zh/ROS1/2.3.0',collapsed: true,
            items: [
                { text: '2.3.1 参数服务器理论模型', link: '/zh/ROS1/2.3.1' },
                { text: '2.3.2 参数操作(Python)', link: '/zh/ROS1/2.3.2' },
            ]
           },
           { text: '2.4 常用命令', link: '/zh/ROS1/2.4.0',collapsed: true, 
            items: [
                { text: '2.4.1 rosnode', link: '/zh/ROS1/2.4.1' },
                { text: '2.4.2 rostopic', link: '/zh/ROS1/2.4.2' },
                { text: '2.4.3 rosmsg', link: '/zh/ROS1/2.4.3' },
                { text: '2.4.4 rosservice', link: '/zh/ROS1/2.4.4' },
                { text: '2.4.5 rossrv', link: '/zh/ROS1/2.4.5' },
                { text: '2.4.6 rosparam', link: '/zh/ROS1/2.4.6' },
            ]
           },
           { text: '2.5 通信机制实操', link: '/zh/ROS1/2.5.0',collapsed: true,
            items: [
                { text: '2.5.1 实操01_话题发布', link: '/zh/ROS1/2.5.1' },
                { text: '2.5.2 实操02_话题订阅', link: '/zh/ROS1/2.5.2' },
                { text: '2.5.3 实操03_服务调用', link: '/zh/ROS1/2.5.3' },
                { text: '2.5.4 实操04_参数设置', link: '/zh/ROS1/2.5.4' },
            ]
           },
           { text: '2.6 通信机制比较', link: '/zh/ROS1/2.6.0'},
           { text: '2.7 本章小结', link: '/zh/ROS1/2.7.0'}
        ]
      }
    ],
