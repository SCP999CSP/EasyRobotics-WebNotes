...
// 8.2.3 配置文件管理//    // 
        ...
        items: [
          { text: '3.1 Lists', 
           ...
           { text: '3.4 Sets', 
            ...
            collapsed: true,
            items: [
              { text: '3.4.1 Element Uniqueness in Sets', link: '/Python/3.4.1' },
              { text: '3.4.2 Set Operations (Union / Intersection / Difference)', link: '/Python/3.4.2' },
              { text: '3.4.3 Sets vs Lists', link: '/Python/3.4.3' },
            ]
           },
        ]
      },
      {
        text: 'Chapter 4: Functions and Modules',
        link: '/Python/4.0.0',
        items: [
          { text: '4.1 Function Basics', 
            link: '/Python/4.1.0',
            collapsed: true,
            items: [
              { text: '4.1.1 Function Definition (def)', link: '/Python/4.1.1' },
              { text: '4.1.2 Parameters and Return Values', link: '/Python/4.1.2' },
              { text: '4.1.3 Default and Variable Parameters', link: '/Python/4.1.3' },
            ]
           },
           { text: '4.2 Scope and Anonymous Functions', 
            link: '/Python/4.2.0',
            collapsed: true,
            items: [
              { text: '4.2.1 Local and Global Variables', link: '/Python/4.2.1' },
              { text: '4.2.2 Lambda Expressions', link: '/Python/4.2.2' },
              { text: '4.2.3 Closure Basics', link: '/Python/4.2.3' },
            ]
           },
           { text: '4.3 Modules and Packages', 
            link: '/Python/4.3.0',
            collapsed: true,
            items: [
              { text: '4.3.1 Import Methods', link: '/Python/4.3.1' },
              { text: '4.3.2 Custom Modules', link: '/Python/4.3.2' },
              { text: '4.3.3 Package Structure and __init__.py', link: '/Python/4.3.3' },
            ]
           },
        ]
      },
    ...
    '/ROS1/':[{
        text: 'ROS1 Note'},
      {
        ...
        items: [
          { text: '1.1 Introduction to ROS', 
            ...
            collapsed: true,
            items: [
              { text: '1.1.1 ROS Concepts', link: '/ROS1/1.1.1' },
              { text: '1.1.2 ROS Design Goals', link: '/ROS1/1.1.2' },
              { text: '1.1.3 Evolution of ROS', link: '/ROS1/1.1.3' }
            ]
           },
           { text: '1.2 Installing ROS', 
            ...
            collapsed: true,
            items: [
              { text: '1.2.1 Installing ROS', link: '/ROS1/1.2.1' },
              { text: '1.2.2 Testing ROS', link: '/ROS1/1.2.2' }
            ]
           },
           { text: '1.3 Quick ROS Experience', 
            ...
            collapsed: true,
            items: [
              { text: '1.3.1 HelloWorld Overview', link: '/ROS1/1.3.1' },
              { text: '1.3.2 HelloWorld', link: '/ROS1/1.3.2' }
            ]
           },
          { text: '1.4 ROS Dev Env Setup', 
            ...
            collapsed: true,
            items: [
              { text: '1.4.1 Terminal Installation', link: '/ROS1/1.4.1' },
              { text: '1.4.2 Installing VScode', link: '/ROS1/1.4.2' },
              { text: '1.4.3 Launch File', link: '/ROS1/1.4.3' },
            ]
           },
           { text: '1.5 ROS Architecture', 
            ...
            collapsed: true,
            items: [
              { text: '1.5.1 ROS File System', link: '/ROS1/1.5.1' },
              { text: '1.5.2 Filesystem Commands', link: '/ROS1/1.5.2' },
              { text: '1.5.3 Computation Graph', link: '/ROS1/1.5.3' },
            ]
           },
           { text: '1.6 Chapter Summary', link: '/ROS1/1.6.0'},
        ]
      },
...

      {
        ...
        link: '/ROS1/2.0.0',
        items: [
          { text: '2.1 Topic Communication', link: '/ROS1/2.1.0',collapsed: true,
            items: [
               { text: '2.1.1 Topic Communication Theoretical Model', link: '/ROS1/2.1.1' },
               { text: '2.1.2 Topic Communication Basic Operations', link: '/ROS1/2.1.2' },
               { text: '2.1.3 Topic Communication Custom msg', link: '/ROS1/2.1.3' },
               { text: '2.1.4 Topic Communication Custom msg Call', link: '/ROS1/2.1.4' }
            ]
          },
          { text: '2.2 Service Communication', link: '/ROS1/2.2.0',collapsed: true,
            items: [
                { text: '2.2.1 Service Communication Theoretical Model', link: '/ROS1/2.2.1' },
                { text: '2.2.2 Service Communication Custom srv', link: '/ROS1/2.2.2' },
                { text: '2.2.3 Service Communication Custom srv Call', link: '/ROS1/2.2.3' },
            ]
           },
          { text: '2.3 参数服务器', link: '/ROS1/2.3.0',collapsed: true,
            items: [
                { text: '2.3.1 参数服务器理论模型', link: '/ROS1/2.3.1' },
                { text: '2.3.2 参数操作(Python)', link: '/ROS1/2.3.2' },
            ]
           },
           { text: '2.4 常用命令', link: '/ROS1/2.4.0',collapsed: true,
            items: [
                { text: '2.4.1 rosnode', link: '/ROS1/2.4.1' },
                { text: '2.4.2 rostopic', link: '/ROS1/2.4.2' },
                { text: '2.4.3 rosmsg', link: '/ROS1/2.4.3' },
            ]
           },
           { text: '2.5 通信机制实操', link: '/ROS1/2.5.0',collapsed: true,
            items: [
                { text: '2.5.1 实操01_话题发布', link: '/ROS1/2.5.1' },
                { text: '2.5.2 实操02_话题订阅', link: '/ROS1/2.5.2' },
                { text: '2.5.3 实操03_服务调用', link: '/ROS1/2.5.3' },
                { text: '2.5.4 实操04_参数设置', link: '/ROS1/2.5.4' },
            ]
           },
           { text: '2.6 通信机制比较', link: '/ROS1/2.6.0'},
           { text: '2.7 本章小结', link: '/ROS1/2.7.0'}
        ]
      }
    ]    
}